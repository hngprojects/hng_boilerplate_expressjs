...
export const makePaymentLemonSqueezy = async (req: Request, res: Response) => {
    try {
        return res.send(`<a href="https://ifeoluwa-hng-stage-5.lemonsqueezy.com/buy/bf9fee27-d226-4637-a32f-013bd717c3b3?embed=1" class="lemonsqueezy-button">Make Payments</a><script src="https://assets.lemonsqueezy.com/lemon.js" defer></script>`)
    } catch (error) {
        console.error(error);
