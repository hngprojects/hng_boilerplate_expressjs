...
const seed = async () => {
  try {
    ...
    log.info('Seeding script started...');

    await AppDataSource.initialize(); // Ensure DataSource is initialized
    ...
    product1.price = 20.0;
    product1.category = 'Category for product 1';
    product1.user = user1;
    ...
    product2.price = 30.0;
    product2.category = 'Category for product 2';
    product2.user = user1;
    ...
    product3.price = 40.0;
    product3.category = 'Category for product 3';
    product3.user = user2;
    ...
    product4.price = 50.0;
    product4.category = 'Category for product 4';
    product4.user = user2;
